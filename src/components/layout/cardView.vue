...
.card-wrap2:hover .card-info2 {
  transform: translateY(0);
}
.card-wrap2:hover .card-info2 p {
  opacity: 1;
}
.card-wrap2:hover .card-info2, .card-wrap2:hover .card-info2 p {
  transition: 0.6s cubic-bezier(0.23, 1, 0.32, 1);
}
.card-wrap2:hover .card-info2:after {
  transition: 5s cubic-bezier(0.23, 1, 0.32, 1);
  opacity: 1;
  transform: translateY(0);
}
.card-wrap2:hover .card-bg2 {
  transition: 0.6s cubic-bezier(0.23, 1, 0.32, 1), opacity 5s cubic-bezier(0.23, 1, 0.32, 1);
  opacity: 0.8;
}
.card-wrap2:hover .card2 {
